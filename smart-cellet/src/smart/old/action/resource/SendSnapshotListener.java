 ...
 * 发送快照监听器
 */
public final class SendSnapshotListener extends AbstractListener {

	public SendSnapshotListener(Cellet cellet) {
		super(cellet);
	}
	...
	public void onAction(ActionDialect action) {
		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				this.response(Action.SENDSNAPSHOT, params);
			} else {
				this.reportHTTPError(Action.SENDSNAPSHOT);
			}
			break;
		default:
			Logger.w(SendSnapshotListener.class,
