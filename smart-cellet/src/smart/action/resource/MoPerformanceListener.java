...
public class MoPerformanceListener extends AbstractListener {

	public MoPerformanceListener(Cellet cellet) {
		super(cellet);
	}
		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				try {
					...
					System.out.println("moperformance<-" + data);
					// 设置参数
				...
				this.response(Action.MOPERFORMANCE, params);
			} else {
				this.reportHTTPError(Action.MOPERFORMANCE);
			}
			break;
		default:
			Logger.w(MoPerformanceListener.class,
