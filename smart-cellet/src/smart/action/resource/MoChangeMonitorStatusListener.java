 ...
 * 改变监控状态监听器
 */
public final class MoChangeMonitorStatusListener extends AbstractListener {

	public MoChangeMonitorStatusListener(Cellet cellet) {
		super(cellet);
	}
	...
	public void onAction(ActionDialect action) {
		...
		StringBuilder url = new StringBuilder(this.getHost())
				.append(API.MOCHANGEMONITORSTATUS);
		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				try {
					...
					System.out.println("moChangeMonitorStatus<---" + data);
					// 设置参数
				...
				this.response(Action.MOCHANGEMONITORSTATUS, params);
			} else {
				this.reportHTTPError(Action.MOCHANGEMONITORSTATUS);
			}
			break;
		default:
			Logger.w(MoChangeMonitorStatusListener.class,
