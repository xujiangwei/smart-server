...
public class BpCloseCodeListListener extends AbstractListener{

	public BpCloseCodeListListener(Cellet cellet) {
		super(cellet);
	}
	...
	public void onAction(ActionDialect action) {
		...
		StringBuilder url = new StringBuilder(context.getAPIHost()).append("/").append(API.CLOSECODELIST);
		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				this.reportHTTPError(Action.CLOSECODELIST);
			}
