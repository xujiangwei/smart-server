 ...
 * 添加关注监听
 */
public class AddAttentionListener extends AbstractListener {
			...
			case HttpStatus.OK_200:
				...
				if (null != bytes) {
					...
					try {
						...
						this.response(token, Action.ADDATTENTION, params);

					} catch (JSONException e) {
						e.printStackTrace();
					}
				} else {
					this.reportHTTPError(token, Action.ADDATTENTION);
				}
				break;
			default:
				Logger.w(AddAttentionListener.class,
