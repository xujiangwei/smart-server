		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				try {
					...
					System.out.println("messageDeleteTag<  " + data);
					// 设置参数
				...
				this.response(Action.MESSAGETAGDELETE, params);
			} else {
				this.reportHTTPError(Action.MESSAGETAGDELETE);
			}
			break;
		default:
			Logger.w(MessageTagAddListener.class,
