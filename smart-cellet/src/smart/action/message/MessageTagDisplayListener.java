 ...
 *
 */
public final class MessageTagDisplayListener extends AbstractListener {
	...
	public void onAction(ActionDialect action) {
		...
		// URL
		StringBuilder url = new StringBuilder(API.MESSAGETAGDISPLAY);
		...
		try {
			...
			isDisplay = json.getInt("isDisplay");
		...
		capsule.append("isDisplay", isDisplay);
		...
		case HttpStatus.OK_200:
			...
			if (null != bytes) {
				...
				this.reportHTTPError(Action.MESSAGETAGDISPLAY);
			}
			break;
		default:
			Logger.w(MessageTagDisplayListener.class,
